...
surface{
    ...
    index = 1;              # list des tag des surfaces concernées: ceux sont les mêmes tag donnée depuis gmsh
    C     = 0.0 0.0 0.0;    # Coordonnées du point de référence pour le calcul des différentes forces
    time  = ricker;         # fonction en temps : ricker, gauss, analytic
    freq  = 30.0;
    tau   = 0.0333333333;
    ampli = 100;
    ...
    var   ="t";
    fxx   ="sin(pi*t/0.005)*sign(0.005-t)";
};
