...
!@ This subroutine is used to compute the value of the function f(x,y,t)
!@ for given x, y and t values. The varaible "t" is related to time variable
!@
SUBROUTINE f2D(f, valx, valy, valt, res)
  ...
  REAL(rn), DIMENSION(1),   INTENT(IN)               :: valx, valy, valt
  ...
  CHARACTER(len=256)                                 :: SourceFile = 'func2D'
