...
contains
     ...
     real(kind=8), dimension(0:2)       ,  intent(in) :: coord
     real(kind=8),dimension(0:2),         intent(out) :: deriveU, veloc0
     type(FoncValue)     :: Sourcef
     real(kind=8)        :: dot
     ...
     real(kind=8),                         intent(in) :: time,PWspeed
     real(kind=8), dimension(0:2)       ,  intent(in) :: coord
     real(kind=8), dimension(0:2)       ,  intent(out):: displ, accel, veloc
     type(FoncValue)    :: Sourcef
     type (source)      :: Sour
     ...
     !----------------------------------------------------------------------------------
     !----------------------------------------------------------------------------------
     real(kind=8) function RickerPW(xx, f0, C0, char)  result(Ricker)
     
     implicit none
     real(kind=8), intent(in) :: f0, xx,C0
