    ...
    do k = 0,ngllz-1
        do j = 0,nglly-1
            do i = 0,ngllx-1
                ...
                !=====================
                !
                xt1 = sxx * xi1(i,j,k) + sxy * xi2(i,j,k) + sxz * xi3(i,j,k)
                xt2 = sxx * et1(i,j,k) + sxy * et2(i,j,k) + sxz * et3(i,j,k)
                xt3 = sxx * ga1(i,j,k) + sxy * ga2(i,j,k) + sxz * ga3(i,j,k)
                !
                !=====================
                !       FY
                !=====================
                !
                xt5 = syy * xi2(i,j,k) + sxy * xi1(i,j,k) + syz * xi3(i,j,k)
                xt6 = syy * et2(i,j,k) + sxy * et1(i,j,k) + syz * et3(i,j,k)
                xt7 = syy * ga2(i,j,k) + sxy * ga1(i,j,k) + syz * ga3(i,j,k)
                !
                !=====================
                !       FZ
                !=====================
                !
                xt8  = szz * xi3(i,j,k) + sxz * xi1(i,j,k) + syz * xi2(i,j,k)
                xt9  = szz * et3(i,j,k) + sxz * et1(i,j,k) + syz * et2(i,j,k)
                xt10 = szz * ga3(i,j,k) + sxz * ga1(i,j,k) + syz * ga2(i,j,k)
