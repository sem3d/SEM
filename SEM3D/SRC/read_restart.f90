...
#include "index.h"
        ...
        real(fpp), allocatable, dimension(:) :: epsilonvol, rvol, rxx, ryy, rxy, rxz, ryz
    ...
    subroutine read_EpsilonDev(Tdomain, elem_id)
        ...
        type (domain), intent (INOUT):: Tdomain
        integer(HID_T), intent(IN) :: elem_id
        real(fpp), allocatable, dimension(:) :: eps_dev_xx, eps_dev_yy, eps_dev_xy, eps_dev_xz, eps_dev_yz
    ...
    subroutine read_Stress_nl(Tdomain, elem_id)
        ...
        integer(HID_T), intent(IN) :: elem_id
#ifndef CPML
        real(fpp), allocatable, dimension(:) :: stress_nl
        integer :: idx, ngll, bnum, ee
        integer :: n, i, j, k
        integer :: n_solid
    ...
    subroutine read_Strain_nl(Tdomain, elem_id)
        ...
        integer(HID_T), intent(IN) :: elem_id
#ifndef CPML
        real(fpp), allocatable, dimension(:) :: strain_nl
        integer :: idx, ngll, bnum, ee
        integer :: n, i, j, k
        integer :: n_solid
    ...
    subroutine read_Center_nl(Tdomain, elem_id)
        ...
        integer(HID_T), intent(IN) :: elem_id
#ifndef CPML
        real(fpp), allocatable, dimension(:) :: center_nl
        integer :: idx, ngll, bnum, ee
        integer :: n, i, j, k
        integer :: n_solid
    ...
    subroutine read_Radius_nl(Tdomain, elem_id)
        ...
        integer(HID_T), intent(IN) :: elem_id
#ifndef CPML
        real(fpp), allocatable, dimension(:) :: radius_nl
        integer :: idx, ngll, bnum, ee
        integer :: n, i, j, k
        integer :: n_solid
    ...
    subroutine read_Veloc_Fluid_PML(Tdomain, elem_id)
        ...
        type (domain), intent (INOUT):: Tdomain
        integer(HID_T), intent(IN) :: elem_id
        real(fpp), allocatable, dimension(:) :: Veloc
        integer :: idx, ngll, bnum, ee
        integer :: n, i, j, k
    ...
    subroutine read_restart (Tdomain,rg, isort)
        ...
        if (Tdomain%sdomdg%nglltot.gt.0) then
            call read_dataset(elem_id, "sldg_Veloc", Tdomain%sdomdg%Qasm, ibase=0)
            call read_dataset(elem_id, "sldg_Displ", Tdomain%sdomdg%Qasm, ibase=0)
        end if
