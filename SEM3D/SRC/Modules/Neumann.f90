module sneu
    ...
    ! Guillot, 08/2012: new fields

    implicit none

    ! Neumann face properties
    type :: face_Neu
       integer :: Face,dir,ngll1,ngll2,mat_index
    ...
    type Neu
       ...
       type(Face_Neu_old), dimension (:), pointer :: nFace
       type(Edge_Neu_old), dimension (:), pointer :: nEdge
       type(Vertex_Neu_old), dimension (:), pointer :: nVertex
