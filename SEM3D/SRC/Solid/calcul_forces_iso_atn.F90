...
#if GENGLL4
        case(4)
            call calcul_forces_iso_atn_4(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLL5
        case(5)
            call calcul_forces_iso_atn_5(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLL6
        case (6)
            call calcul_forces_iso_atn_6(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLL7
        case (7)
            call calcul_forces_iso_atn_7(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLL8
        case (8)
            call calcul_forces_iso_atn_8(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLL9
        case (9)
            call calcul_forces_iso_atn_9(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
#if GENGLLN
        case default
            call calcul_forces_iso_atn_n(dom,dom%ngll,bnum,Fox,Foy,Foz,Depla,Sigma)
#endif
        end select
