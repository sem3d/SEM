...
subroutine calcul_forces_aniso_att(Fox,Foy,Foz, invgrad, &
    ...
    real, dimension(0:n_solid-1,0:ngllx-1,0:nglly-1,0:ngllz-1), intent(in) :: R_xx_,R_yy_,R_xy_,R_xz_,R_yz_
