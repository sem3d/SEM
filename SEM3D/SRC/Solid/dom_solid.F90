                ...
                do j=0,ngll-1
                    do i=0,ngll-1
                        ...
                        if (out_variables(OUT_PRESSION) == 1) then
                            ...
                            fieldP(i,j,k) = -(dom%Lambda_(i,j,k,bnum,ee)+two*M_1_3*dom%Mu_(i,j,k,bnum,ee))*(DXX+DYY+DZZ)
                        endif
                        ! EPSVOL
                        ...
                        if (out_variables(OUT_ENERGYP).or. &
                            out_variables(OUT_ENERGYS).or.&
                            out_variables(OUT_STRESS_DEV)) then
                            if (dom%aniso) then
