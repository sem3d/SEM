...
contains
    subroutine double_couple(Tdomain,rg)
        ...
        real(fpp) :: xi,eta,zeta,coord,xa,ya,za,xb,yb,zb,num,denom,prod
        real(fpp), dimension(:), allocatable :: xpol,ypol,zpol,xdh,ydh,zdh
        real(fpp), dimension(0:2,0:2) :: TMP, M
