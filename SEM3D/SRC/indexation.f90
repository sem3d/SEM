...
contains
    ...
    !----------------------------------------------------------------------------
    !----------------------------------------------------------------------------
    subroutine ind_elem_edge(ind_edge,orient_edge,ngllx,nglly,ngllz,index_elem)
        !- routine giving info about index array for Iglobnum, depending on the index of
        ...
        implicit none
        integer, intent(in)  :: ind_edge,orient_edge,ngllx,nglly,ngllz
    ...
    !----------------------------------------------------------------------------
    !----------------------------------------------------------------------------
    subroutine ind_elem_vertex(ind_vertex,ngllx,nglly,ngllz,index_elem)
        implicit none
        integer, intent(in)  :: ind_vertex,ngllx,nglly,ngllz
