            ...
            do k = 0,ngll-1
                do j = 0,ngll-1
                    do i = 0,ngll-1
                        ...
                        select case (Tdomain%specel(n)%domain)
                            case (DM_SOLID_CG)
                                dens(idx) = Tdomain%sdom%props (ee,i,j,k,cRho,bnum)
                            case (DM_SOLID_DG)
            ...
            do k = 0,ngll-1
                do j = 0,ngll-1
                    do i = 0,ngll-1
                        ...
                        select case (Tdomain%specel(n)%domain)
                            case (DM_SOLID_CG)
                                lamb(idx) = Tdomain%sdom%props(ee,i,j,k,cLambda,bnum)
            ...
            do k = 0,ngll-1
                do j = 0,ngll-1
                    do i = 0,ngll-1
                        ...
                        select case (Tdomain%specel(n)%domain)
                            case (DM_SOLID_CG)
                                mu(idx) = Tdomain%sdom%props(ee,i,j,k,cMu,bnum)
                ...
                do k = 0,ngll-1
                        do j = 0,ngll-1
                                do i = 0,ngll-1
                                        ...
                                        select case (Tdomain%specel(n)%domain)
                                           case (DM_SOLID_CG)
                                                C11(idx) = Tdomain%sdom%props(ee,i,j,k,cAniso+0,bnum)
                                           case (DM_SOLID_DG)
                                                C11(idx) = -1d0
                                           case (DM_SOLID_CG_PML)
                                                C11(idx) = -1d0
