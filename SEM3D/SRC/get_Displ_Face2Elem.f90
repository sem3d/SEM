...
if ( Tdomain%specel(n)%Orient_Faces(3) == 0 ) then
  Tdomain%specel(n)%Forces(1:ngllx-2,nglly-1,1:ngllz-2,0) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0) 
  Tdomain%specel(n)%Forces(1:ngllx-2,nglly-1,1:ngllz-2,1) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,1) 
  Tdomain%specel(n)%Forces(1:ngllx-2,nglly-1,1:ngllz-2,2) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,2) 
...
if ( Tdomain%specel(n)%Orient_Faces(4) == 0 ) then
  Tdomain%specel(n)%Forces(0,1:nglly-2,1:ngllz-2,0) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0) 
  Tdomain%specel(n)%Forces(0,1:nglly-2,1:ngllz-2,1) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,1) 
  Tdomain%specel(n)%Forces(0,1:nglly-2,1:ngllz-2,2) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,2) 
...
if ( Tdomain%specel(n)%Orient_Faces(5) == 0 ) then
  Tdomain%specel(n)%Forces(1:ngllx-2,1:nglly-2,ngllz-1,0) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0) 
  Tdomain%specel(n)%Forces(1:ngllx-2,1:nglly-2,ngllz-1,1) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,1) 
  Tdomain%specel(n)%Forces(1:ngllx-2,1:nglly-2,ngllz-1,2) =  Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,2) 
