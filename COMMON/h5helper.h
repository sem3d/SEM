...
void  h5h_read_dset_2d_d(hid_t g, const char* dname, std::vector<double>& v, std::vector<double>& w);
void  h5h_read_dset_1d_i(hid_t g, const char* dname, std::vector<int>& v);
